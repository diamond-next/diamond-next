...
class TestTSDBdHandler(TestCase):
    ...
    def test_HTTPError(self, mock_urlopen, mock_request):
        ...
        config["port"] = "4242"
        metric = Metric(
            "servers.myhostname.cpu.cpu_count",
            123,
            raw_value=123,
            timestamp=1234567,
            host="myhostname",
        ...
        exception = urllib.error.HTTPError(
            url=self.url, code=404, msg="Error", hdrs=header, fp=None
        )
    ...
    def test_batch(self, mock_urlopen, mock_request):
        ...
        metric2 = Metric(
            "servers.myhostname.cpu.cpu_time",
            123,
            raw_value=456,
            timestamp=5678910,
            host="myhostname",
    ...
    def test_prefix(self, mock_urlopen, mock_request):
        ...
        handler.process(metric)
        body = (
            '[{"timestamp": 1234567, "metric": "diamond.cpu.cpu_count", '
    ...
    def test_cpu_metrics_taghandling_default(self, mock_urlopen, mock_request):
        ...
        metric = Metric(
            "servers.myhostname.cpu.cpu0.user",
            123,
            raw_value=123,
            timestamp=1234567,
            host="myhostname",
        ...
        handler.process(metric)
        body = (
            '[{"timestamp": 1234567, "metric": "cpu.user", "value": '
    ...
    def test_cpu_metrics_taghandling_0(self, mock_urlopen, mock_request):
        ...
        handler.process(metric)
        body = (
            '[{"timestamp": 1234567, "metric": "cpu.cpu0.user", "value": '
    ...
    def test_cpu_metrics_taghandling_default2(self, mock_urlopen, mock_request):
        ...
        metric = Metric(
            "servers.myhostname.cpu.total.user",
            123,
            raw_value=123,
            timestamp=1234567,
            host="myhostname",
    ...
    def test_cpu_metrics_taghandling_1(self, mock_urlopen, mock_request):
        ...
        handler.process(metric)
        body = (
            '[{"timestamp": 1234567, "metric": "cpu.total.user", "value": '
            '123, "tags": {"myFirstTag": "myValue", "hostname": '
            '"myhostname"}}]'
        )
        header = {"Content-Type": "application/json"}
    ...
    def test_haproxy_metrics_default(self, mock_urlopen, mock_request):
        ...
        metric = Metric(
            "servers.myhostname.haproxy.SOME-BACKEND.SOME-SERVER." "bin",
            123,
            raw_value=123,
            timestamp=1234567,
            host="myhostname",
        ...
        handler.process(metric)
        body = (
            '[{"timestamp": 1234567, "metric": "haproxy.bin",'
    ...
    def test_haproxy_metrics(self, mock_urlopen, mock_request):
        ...
        handler.process(metric)
        body = (
            '[{"timestamp": 1234567, "metric": "haproxy.SOME-BACKEND.SOME-'
    ...
    def test_diskspace_metrics_default(self, mock_urlopen, mock_request):
        ...
        metric = Metric(
            "servers.myhostname.diskspace.MOUNT_POINT.byte_percent" "free",
            80,
            raw_value=80,
            timestamp=1234567,
            host="myhostname",
        ...
        handler.process(metric)
        body = (
            '[{"timestamp": 1234567, "metric": "diskspace.'
    ...
    def test_diskspace_metrics(self, mock_urlopen, mock_request):
        ...
        metric = Metric(
            "servers.myhostname.diskspace.MOUNT_POINT.byte_" "percentfree",
            80,
            raw_value=80,
            timestamp=1234567,
            host="myhostname",
        ...
        handler.process(metric)
        body = (
            '[{"timestamp": 1234567, "metric": "diskspace.MOUNT_POINT'
    ...
    def test_iostat_metrics_default(self, mock_urlopen, mock_request):
        ...
        metric = Metric(
            "servers.myhostname.iostat.DEV.io_in_progress",
            80,
            raw_value=80,
            timestamp=1234567,
            host="myhostname",
        ...
        handler.process(metric)
        body = (
            '[{"timestamp": 1234567, "metric": "iostat.io_in_progress", '
    ...
    def test_iostat_metrics(self, mock_urlopen, mock_request):
        ...
        handler.process(metric)
        body = (
            '[{"timestamp": 1234567, "metric": "iostat.DEV.io_in_progress"'
    ...
    def test_network_metrics_default(self, mock_urlopen, mock_request):
        ...
        metric = Metric(
            "servers.myhostname.network.IF.rx_packets",
            80,
            raw_value=80,
            timestamp=1234567,
            host="myhostname",
        ...
        handler.process(metric)
        body = (
            '[{"timestamp": 1234567, "metric": "network.rx_packets", '
    ...
    def test_network_metrics(self, mock_urlopen, mock_request):
        ...
        handler.process(metric)
        body = (
            '[{"timestamp": 1234567, "metric": "network.IF.rx_packets", '
            '"value": 80, "tags": {"myFirstTag": "myValue", "hostname": '
            '"myhostname"}}]'
        )
        header = {"Content-Type": "application/json"}
