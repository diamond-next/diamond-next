...
class TestSquidCollector(CollectorTestCase):
    ...
    def test_should_work_with_fake_data(self, publish_mock):
        _getData_mock = patch.object(
            SquidCollector,
            "_getData",
            Mock(return_value=self.getFixture("fake_counters_1").getvalue()),
        )
        _getData_mock.start()
        ...
        _getData_mock = patch.object(
            SquidCollector,
            "_getData",
            Mock(return_value=self.getFixture("fake_counters_2").getvalue()),
        )
        _getData_mock.start()
        self.collector.collect()
        _getData_mock.stop()
    ...
    def test_should_work_with_real_data(self, publish_mock):
        _getData_mock = patch.object(
            SquidCollector,
            "_getData",
            Mock(return_value=self.getFixture("counters_1").getvalue()),
        )
        _getData_mock.start()
        self.collector.collect()
        _getData_mock.stop()
        ...
        _getData_mock = patch.object(
            SquidCollector,
            "_getData",
            Mock(return_value=self.getFixture("counters_2").getvalue()),
        )
        _getData_mock.start()
        self.collector.collect()
        _getData_mock.stop()
