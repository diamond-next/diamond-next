...
class TestRedisCollector(CollectorTestCase):
    ...
    def test_real_data(self, publish_mock):
        ...
        patch_collector = patch.object(
            RedisCollector, "_get_info", Mock(return_value=data_1)
        )
        patch_config = patch.object(
            RedisCollector, "_get_config", Mock(return_value={"maxmemory": "2097152"})
        )
        ...
        patch_collector = patch.object(
            RedisCollector, "_get_info", Mock(return_value=data_2)
        )
        patch_config = patch.object(
            RedisCollector, "_get_config", Mock(return_value={"maxmemory": "2097152"})
        )
    ...
    def test_hostport_or_instance_config(self, publish_mock):
        testcases = {
            ...
            "unix_socket_host_set": {
                ...
                "calls": [
                    call(
                        "myhost", "localhost", 6379, "/var/run/redis/myhost.sock", None
                    )
                ],
            },
            "instance_1_host": {
            ...
            "unix_socket_instance_1_host": {
                ...
                "calls": [
                    call("nick", "localhost", 6379, "/var/run/redis/myhost.sock", None)
                ],
            },
            "unix_socket_instance_1_hostauth": {
                ...
                "calls": [
                    call(
                        "nick", "localhost", 6379, "/var/run/redis/myhost.sock", "pass"
                    )
                ],
            },
            "instance_1_port": {
    ...
    def test_key_naming_when_using_instances(self, publish_mock):
        ...
        expected_calls = [
            call(
                "nick1.process.connections_received",
                200,
                precision=0,
                metric_type="GAUGE",
            ),
            call(
                "nick1.process.commands_processed",
                100,
                precision=0,
                metric_type="GAUGE",
            ),
            ...
            call(
                "nick2.process.connections_received",
                200,
                precision=0,
                metric_type="GAUGE",
            ),
            call(
                "nick2.process.commands_processed",
                100,
                precision=0,
                metric_type="GAUGE",
            ),
            ...
            call(
                "nick3.process.connections_received",
                200,
                precision=0,
                metric_type="GAUGE",
            ),
            call(
                "nick3.process.commands_processed",
                100,
                precision=0,
                metric_type="GAUGE",
            ),
            ...
            call(
                "nick4.process.connections_received",
                200,
                precision=0,
                metric_type="GAUGE",
            ),
            call(
                "nick4.process.commands_processed",
                100,
                precision=0,
                metric_type="GAUGE",
            ),
            ...
            call(
                "6379.process.connections_received",
                200,
                precision=0,
                metric_type="GAUGE",
            ),
            call(
                "6379.process.commands_processed", 100, precision=0, metric_type="GAUGE"
            ),
        ...
        patch_c = patch.object(
            RedisCollector, "_get_info", Mock(return_value=get_info_data)
        )
