...
from collectors.openstackswiftrecon.openstackswiftrecon import OpenstackSwiftReconCollector
...
class TestOpenstackSwiftReconCollector(CollectorTestCase):
    ...
    def test_recon_publish(self, publish_mock):
        ...
        metrics = {
            'object.object_replication_time': 2409.806068432331,
            'object.object_auditor_stats_ALL.passes': 43887,
            'object.object_auditor_stats_ALL.errors': 0,
            'object.object_auditor_stats_ALL.audit_time': 301695.1047577858,
            'object.object_auditor_stats_ALL.start_time': 1357979417.104742,
            'object.object_auditor_stats_ALL.quarantined': 0,
            'object.object_auditor_stats_ALL.bytes_processed': 24799969235,
            ...
            'object.object_auditor_stats_ZBF.audit_time': 152991.46442770958,
            'object.object_auditor_stats_ZBF.start_time': 1357979462.621007,
