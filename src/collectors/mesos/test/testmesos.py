...
class TestMesosCollector(CollectorTestCase):
    ...
    def test_should_work_for_master_with_real_data(self, publish_mock):
        ...
        urlopen_mock = patch(
            "urllib.request.urlopen", Mock(side_effect=lambda *args: returns)
        )
    ...
    def test_should_work_for_slave_with_real_data(self, publish_mock):
        ...
        urlopen_mock = patch(
            "urllib.request.urlopen", Mock(side_effect=lambda *args: returns.pop(0))
        )
    ...
    def test_http(self):
        ...
        self.assertEqual(
            "http://localhost:5050/metrics/snapshot",
    ...
    def test_https(self):
        ...
        self.assertEqual(
            "https://localhost:5050/metrics/snapshot",
            self.collector._get_url("metrics/snapshot"),
        )
    ...
    def test_sum_statistics(self):
        ...
        self.assertEqual(
            self.collector._sum_statistics(metrics_1, metrics_2),
