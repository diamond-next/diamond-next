...
class TestCephCollectorPublish(CollectorTestCase):
    ...
    def test_simple(self, publish_mock):
        ...
        publish_mock.assert_called_with(
            "prefix.a", 1, metric_type="GAUGE", instance=None, precision=0
        )
    ...
    def test_multiple(self, publish_mock):
        ...
        publish_mock.assert_has_calls(
            [
                call("prefix.a", 1, metric_type="GAUGE", instance=None, precision=0),
                call("prefix.b", 2, metric_type="GAUGE", instance=None, precision=0),
            ]
        )
